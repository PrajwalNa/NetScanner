...
class subnetScan(threading.Thread):
    ...
    def displayScan(self) -> None:
        ...
        for key in self.resultsDict:
            print(f"\033[38;5;228m|\033[38;5;87m{key:<18}\033[38;5;228m|\033[38;5;87m{self.resultsDict[key][0]:<18}\033[38;5;228m|\033[38;5;87m{self.resultsDict[key][1]:<65}\033[38;5;228m|\033[0m")
